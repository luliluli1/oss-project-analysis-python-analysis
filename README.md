...
| 组员 | 主要贡献 |
|------|----------|
| 张嘉政 | • 项目架构设计与文档编写<br>• 分析算法实现与可视化设计<br>• GitHub Actions CI/CD 流水线配置 |
| 刁兴烨| • 数据收集与预处理模块开发<br>• 单元测试与质量保障体系构建<br>• 跨平台兼容性问题修复（Windows Unicode 编码、无头环境图表生成） |
| 苏宇恒 | • 数据收集与预处理模块开发<br>• 单元测试与质量保障体系构建<br>• 跨平台兼容性问题修复（Windows Unicode 编码、无头环境图表生成） |
